...
////////////////////////////////////////////////////////
class CHiveAgentComponent_Deprecated final : public IEntityComponent
{
public:
	CHiveAgentComponent_Deprecated() = default;
	virtual ~CHiveAgentComponent_Deprecated() {}

	// Reflect type to set a unique identifier for this component
	// and provide additional information to expose it in the sandbox
	static void ReflectType(Schematyc::CTypeDesc<CHiveAgentComponent_Deprecated>& desc)
	{
